...
\TODO[I think this is appopriate, I've using original notation from paper before]{Change of notations. $\imd$ - memory dependent current, previously $\im$, $\im$ - the total current, previously $i$. Please confirm whether this is ok.}
