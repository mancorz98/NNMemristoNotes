...
\begin{table}
    ...
    \begin{tabular}{c|cccc}
        \toprule
        $f_s$        & Det-MemODE           & Dual-NN-MemODE       & GMMS Model           & MMS Model            \\
        \midrule
        \textbf{1}   & $1.92 \cdot 10^{-3}$ & $2.07 \cdot 10^{-4}$ & $5.21 \cdot 10^{-2}$ & $7.86 \cdot 10^{-2}$ \\
        \textbf{5}   & $1.60 \cdot 10^{-3}$ & $2.85 \cdot 10^{-4}$ & $3.70 \cdot 10^{-2}$ & $5.59 \cdot 10^{-2}$ \\
        \textbf{10}  & $3.64 \cdot 10^{-3}$ & $1.83 \cdot 10^{-3}$ & $3.43 \cdot 10^{-2}$ & $6.44 \cdot 10^{-2}$ \\
        \textbf{20}  & $8.69 \cdot 10^{-3}$ & $2.27 \cdot 10^{-3}$ & $4.24 \cdot 10^{-2}$ & $7.96 \cdot 10^{-2}$ \\
        \textbf{50}  & $7.86 \cdot 10^{-3}$ & $2.47 \cdot 10^{-3}$ & $4.71 \cdot 10^{-2}$ & $8.29 \cdot 10^{-2}$ \\
        \textbf{100} & $6.24 \cdot 10^{-2}$ & $4.21 \cdot 10^{-3}$ & $1.18 \cdot 10^{-1}$ & $2.10 \cdot 10^{-1}$ \\
        \bottomrule
    \end{tabular}
    \begin{tabular}{c|cccc}
        \toprule
        $f_s$        & Det-MemODE           & Dual-NN-MemODE       & GMMS Model           & MMS Model            \\
        \midrule
        \textbf{1}   & $6.40 \cdot 10^{-3}$ & $4.69 \cdot 10^{-4}$ & $1.20 \cdot 10^{-2}$ & $3.08 \cdot 10^{-2}$ \\
        \textbf{5}   & $4.58 \cdot 10^{-3}$ & $2.11 \cdot 10^{-3}$ & $1.19 \cdot 10^{-2}$ & $3.37 \cdot 10^{-2}$ \\
        \textbf{10}  & $2.74 \cdot 10^{-3}$ & $5.27 \cdot 10^{-4}$ & $1.36 \cdot 10^{-2}$ & $3.93 \cdot 10^{-2}$ \\
        \textbf{20}  & $5.32 \cdot 10^{-3}$ & $1.90 \cdot 10^{-3}$ & $1.84 \cdot 10^{-2}$ & $4.43 \cdot 10^{-2}$ \\
        \textbf{50}  & $2.88 \cdot 10^{-2}$ & $4.26 \cdot 10^{-3}$ & $5.86 \cdot 10^{-2}$ & $8.91 \cdot 10^{-2}$ \\
        \textbf{100} & $5.08 \cdot 10^{-2}$ & $2.63 \cdot 10^{-3}$ & $5.45 \cdot 10^{-2}$ & $7.45 \cdot 10^{-2}$ \\
        \bottomrule
    \end{tabular}
    \begin{tabular}{c|cccc}
        \toprule
        $f_s$        & Det-MemODE           & Dual-NN-MemODE       & GMMS Model           & MMS Model            \\
        \midrule
        \textbf{1}   & $1.99 \cdot 10^{-2}$ & $2.95 \cdot 10^{-3}$ & $1.77 \cdot 10^{-2}$ & $9.95 \cdot 10^{-2}$ \\
        \textbf{5}   & $1.17 \cdot 10^{-2}$ & $1.26 \cdot 10^{-3}$ & $1.73 \cdot 10^{-2}$ & $7.88 \cdot 10^{-2}$ \\
        \textbf{10}  & $1.14 \cdot 10^{-2}$ & $2.08 \cdot 10^{-3}$ & $1.56 \cdot 10^{-2}$ & $5.24 \cdot 10^{-2}$ \\
        \textbf{20}  & $1.09 \cdot 10^{-2}$ & $5.51 \cdot 10^{-3}$ & $1.96 \cdot 10^{-2}$ & $5.09 \cdot 10^{-2}$ \\
        \textbf{50}  & $1.09 \cdot 10^{-2}$ & $3.46 \cdot 10^{-3}$ & $1.87 \cdot 10^{-2}$ & $8.90 \cdot 10^{-2}$ \\
        \textbf{100} & $2.44 \cdot 10^{-2}$ & $1.65 \cdot 10^{-3}$ & $5.63 \cdot 10^{-2}$ & $4.87 \cdot 10^{-2}$ \\
        \bottomrule
    \end{tabular}

    \caption{Comparative loss function analysis between neural network and deterministic models across key electrical characteristics. The neural network approach demonstrates significantly lower loss values, indicating superior modeling fidelity.}
    \label{tab:mms_comp}
\end{table}
