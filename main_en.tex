...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.8\textwidth}
        \includegraphics[width=\textwidth]{figs/Rysowanie_schematów (2).pdf}
        \caption{}
...
\begin{figure}[ht!]
    \centering
    \begin{subfigure}[b]{0.8\textwidth}
        \includegraphics[width=\textwidth]{figs/Rysowanie_schematów (3).pdf}
        \caption{}
        % \label{fig:nn_structure}
    \end{subfigure}
